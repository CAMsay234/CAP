...
def create_tables_if_needed():
    ...
    required_tables = ['nivel_escolaridad','pruebas','sub_pruebas','pacientes', 'historias_clinicas','estado_mental','areas','evaluaciones_neuropsicologicas',
                       'hipotesis' ,'diagnosticos', 'seguimiento',]   # Agrega todas las tablas que esperas

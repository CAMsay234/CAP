import sys
import os
from PyQt5.QtWidgets import QMainWindow, QVBoxLayout, QHBoxLayout, QLabel, QTextEdit, QPushButton, QWidget, QGridLayout, QApplication, QLineEdit
...
class EstadoMentalWindow(QMainWindow):
    def __init__(self, paciente_seleccionado=None):
        ...
        """)
        self.boton_volver.clicked.connect(self.abrir_historia_clinica)
        ...
        """)
        self.boton_guardar.clicked.connect(self.abrir_guardar)
        ...
        self.add_comment_section("ESTADO MENTAL", estados_mentales, main_layout)
    ...
    def abrir_historia_clinica(self):
        """Función para abrir la ventana de Historia Clínica."""
